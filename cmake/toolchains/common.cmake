...
# Project options.
set(BOOST_SOCKS_BUILD_BENCHMARKS ON CACHE STRING "")

# Detect Boost tree.
if(NOT DEFINED BOOST_SOCKS_IN_BOOST_TREE AND EXISTS "${CMAKE_CURRENT_LIST_DIR}/../../../../Jamroot")
    set(BOOST_SOCKS_IN_BOOST_TREE ON CACHE STRING "")
endif()
